...
xlsx::write.xlsx(All_bench, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "All", append = F)
xlsx::write.xlsx(Tissue_bench, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "Tissue", append = T)
xlsx::write.xlsx(CT_bench, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "CellType", append = T)
xlsx::write.xlsx(df, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "global", append = T)
...
xlsx::write.xlsx(All_bench, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "All_All", append = F)
xlsx::write.xlsx(Tissue_bench, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "Tissue_All", append = T)
xlsx::write.xlsx(CT_bench, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "CellType_All", append = T)
xlsx::write.xlsx(CT_CT_DF, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "Tissue_Tissue", append = T)
xlsx::write.xlsx(Tissue_Tissue_df, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "CellType_CellType", append = T)
xlsx::write.xlsx(df, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "global", append = T)
xlsx::write.xlsx(overlap_table_10X, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "overlap_table_10X", append = T)
xlsx::write.xlsx(overlap_table_SS, file = "../FinalTable/R2Q5_Table.xlsx", sheetName = "overlap_table_SS", append = T)
